...
* When working with JSON descriptors (i.e. generated by [pbjs](clis/README.md#pbjs-for-javascript)) and/or reflection only, see the [light library][dist-light] (~16kb gzipped) that excludes the parser. CommonJS entry point is:
